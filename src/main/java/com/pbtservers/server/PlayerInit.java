...
public class PlayerInit {
    ...
    private static final EventNode<Event> DEMO_NODE = EventNode.all("demo")
            ...
            .addListener(PlayerDeathEvent.class, event -> event.setChatMessage(Component.text(event.getPlayer().getUsername() + "ha Muerto!")))
            ...
            .addListener(PlayerDisconnectEvent.class, event -> System.out.println(event.getPlayer().getUsername() + "ha Abandonado el Servidor"))
    ...
    static {
        ...
        inventory = new Inventory(InventoryType.CHEST_1_ROW, Component.text("Inventario Test"));
    }
    ...
    public static void init() {
        ...
        MinecraftServer.getSchedulerManager().buildTask(() -> {
            ...
            final Component header = Component.text("USO DE RAM: " + ramUsage + " MB")
                    .append(Component.newline())
                    .append(Component.text("MSPT: " + MathUtils.round(tickMonitor.getTickTime(), 2) + "ms"))
                    .append(Component.newline())
                    .append(Component.text("TIEMPO DE ACQ: " + MathUtils.round(tickMonitor.getAcquisitionTime(), 2) + "ms"));
